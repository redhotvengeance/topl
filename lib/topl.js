...
(function() {
  ...
  makeTable = (function(_this) {
    return function() {
      var array, i, key, table, tableArray, tableKey, _i, _j, _len, _len1, _ref;
      stripWhitespace();
      progress();
      array = false;
      if (_this.currentCharacter === '[') {
          ...
          if (i === tableArray.length - 1) {
            if (array) {
              ...
              for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
                tableKey = _ref[_j];
                if (tableKey === key) {
                  throw new Error("Check your tables and keys! You\'re attempting an overwrite on line " + _this.line + "!");
                }
              }
            }
          } else {
  ...
  makeKey = (function(_this) {
    return function() {
      var key, value;
      if (/\w/i.test(_this.currentCharacter)) {
        key = _this.currentCharacter;
        if (nextCharacter() !== ' ' && nextCharacter() !== '\t' && nextCharacter() !== '=') {
          while (progress()) {
            key += _this.currentCharacter;
